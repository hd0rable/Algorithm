...
### 입력 
 ...
 <p style="user-select: auto !important;">첫째 줄에 N (1 ≤ N ≤ 1,500,000)이 주어진다.</p>

<p style="user-select: auto !important;">둘째 줄부터 N개의 줄에 T<sub style="user-select: auto !important;">i</sub>와 P<sub style="user-select: auto !important;">i</sub>가 공백으로 구분되어서 주어지며, 1일부터 N일까지 순서대로 주어진다. (1 ≤ T<sub style="user-select: auto !important;">i</sub> ≤ 50, 1 ≤ P<sub style="user-select: auto !important;">i</sub> ≤ 1,000)</p>
